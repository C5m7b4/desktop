...
export const SortZA: React.FC<Props> = ({ scale = 15, style, onClick }) => {
  ...
  return (
    ...
    >
      <text fill="#1c75bc" transform="translate(48.49 419.59)">
        <tspan x="0" y="0">
          A
        </tspan>
      </text>
      ...
      <line
        ...
        y2="20.35"
      />
      <text fill="#000" transform="translate(48.49 219.19)">
        <tspan x="0" y="0">
          Z
        </tspan>
      </text>
